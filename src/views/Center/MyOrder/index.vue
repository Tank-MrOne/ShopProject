<template>
  <div class="order-content">
    ...
    /> -->
    <el-pagination background layout="prev, pager, next ,total" @current-change="getOrders" :total="total" :pager-count="5" prev-text="上一页" :curent-page="page" :page-size="limit" next-text="下一页"></el-pagination>
  </div>
</template>
