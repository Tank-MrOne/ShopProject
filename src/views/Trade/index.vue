<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="(address, index) in tradeInfo.userAddressList" :key="address.id">
        <span @click="selectedAddress=address" class="username" :class="{selected:address===selectedAddress}">{{address.consignee}}</span>
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{selectedAddress.userAddress}}</span> <br>
        收货人：<span>{{selectedAddress.consignee}}</span><br>
        电话号码： <span>{{selectedAddress.phoneNum}}</span>
      </div>
    </div>
    <div class="sub clearFix">
      <a href="javascript:;" class="subBtn" to="/pay" @click="submit">提交订单</a>
    </div>
  </div>
</template>
